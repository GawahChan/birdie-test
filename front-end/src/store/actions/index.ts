...
export const RECEIVE_DATA_TIMESTAMP = 'RECEIVE_DATA_TIMESTAMP';
...
export const receiveDataTimeStamp = (timeStamp: any, allMonths: any, eachMonth: any ) => ({
    type: RECEIVE_DATA_TIMESTAMP, 
    timeStamp,
    allMonths,
    eachMonth
});